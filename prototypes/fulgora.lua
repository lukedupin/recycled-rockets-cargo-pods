...
recycledRocketSiloPlaced.icon = "__recycled-rockets__/graphics/rocket-silo-re-fulgora.png"

-- Inventory item for the recycled rocket silo
local recycledRocketSiloItem = {
	type = "item",
	name = "recycled-mag-rocket-silo",
	icon = "__recycled-rockets__/graphics/rocket-silo-re-fulgora.png",
...
local recycledMagFuelItem = {
	...
	icon = "__recycled-rockets__/graphics/rocket-fuel.png",
	subgroup = "space-related",
	order = "d[rocket-silo]",
	inventory_move_sound = space_age_item_sounds.mechanical_large_inventory_move,
	pick_sound = space_age_item_sounds.mechanical_large_inventory_pickup,
...
local recycledRocketTech = {
	type = "technology",
	name = "recycled-mag-rocket-ship",
	icon = "__recycled-rockets__/graphics/rocket-silo-tech-fulgora.png",
	icon_size = 256,
	essential = true,
	effects =
	{
